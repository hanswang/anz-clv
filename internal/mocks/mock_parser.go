...
// Source: github.com/hanswang/clv/internal/parser (interfaces: ParserManager)
...
func (m *MockParserManager) ParseCSV(arg0 []string) (*map[string]types.Entity, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ParseCSV", arg0)
...
func (mr *MockParserManagerMockRecorder) ParseCSV(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ParseCSV", reflect.TypeOf((*MockParserManager)(nil).ParseCSV), arg0)
}
